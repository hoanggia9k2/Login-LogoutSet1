...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://websitemvc/mvc/publics/css/add.css">
</head>
<body>
<div class="container">
	<div id='form' class="p-3 my-3 col-md-7  mx-auto">
		...
		<form method="post" id="newform" class="needs-validation was-validated">
			...
			<center><a href="http://websitemvc/home" type="sumbit" class="btn mt-2">Cancel</a></center>
		</form>
	</div>
</div>
</body>
